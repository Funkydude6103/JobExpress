                ...
                <div class="row gy-5 gx-4">
                    <div class="col-lg-8">
                        ...
                        <div class="">
                            ...
                            if(!js.appliedCheck(request.getParameter("jobID"), request.getParameter("id") ))
                            {
                            %>
                            <form action="ApplyJob" method="post">
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <input class="btn btn-primary w-100" type="submit" value="Apply Now">
                                    </div>
                                </div>
                            </form>
                            <%} 
                            ...
                            %>
                            <h4 style="border: 1px solid #ccc; padding: 10px; background-color: #f9f9f9; text-align: center;">Already Applied For this Job</h4>
