...
<body>
   ...
   <form action="BuildJobSeekerProfile" method="post" enctype="multipart/form-data">
    ...
    <a href="data:application/pdf;base64,<%= Base64.getEncoder().encodeToString(js.getResume()) %>" style=" background-color: #4CAF50;
  color: #fff;
  padding: 10px 20px;
  border: none;
  border-radius: 5px;
  cursor: pointer;
  font-size: 16px;
  margin-right: 10px;" target="_blank" >View Resume</a><br>
