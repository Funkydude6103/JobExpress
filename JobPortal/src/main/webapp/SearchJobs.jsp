...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <h1 id= "gay"class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Search Result</h1>
                <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <div class="tab-content">
                        ...
                        Vector<Job> jobs=js.viewJobs(request.getParameter("keyword"),request.getParameter("location"),request.getParameter("category"));
                        for(Job j:jobs)
                        {
                        %>
