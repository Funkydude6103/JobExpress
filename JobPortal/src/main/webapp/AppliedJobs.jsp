...
<body>
    <header class="header">
      ...
      <li><a href="JobSeeker.jsp?id=<%=request.getParameter("id")%>">Home</a></li>
          ...
          <li><a href="AppliedJob.html">Applied Jobs</a></li>
    ...
    <tbody>
        ...
        Vector<JobApplication> applications =ja.getApplicationsByJobSeekerID(request.getParameter("id"));
           ...
           <%if(!applications.get(i).getApplicationStatus().equals("pending"))
            ...
            <tr>
                ...
                <td>
                        ...
                        <%if(applications.get(i).getApplicationStatus().equals("Accepted"))
                        { %>
    ...
    cursor: pointer;
    border-radius: 4px;
    margin-right: 4px ;display: inline-block;"class="button" type="submit" name="action" value="Review"  onclick="window.location.href='GiveReview.jsp?id=<%=request.getParameter("id")%>&EmpID=<%=applications.get(i).getEmpID()%>';">
    <%} %>
    ...
    cursor: pointer;
    border-radius: 4px;
    margin-right: 4px; display: inline-block;"class="button" href="OneJob.jsp?id=<%=request.getParameter("id")%>&empID=<%=applications.get(i).getEmpID()%>&jobID=<%=applications.get(i).getJobID()%>">View-Job</a>
